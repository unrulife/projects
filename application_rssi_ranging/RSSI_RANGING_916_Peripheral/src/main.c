...
#if MAX_POWER_1217
    ////Max Power: VAON=1.2V > VCORE=1.2V, VDCDC=2.0V, VRF=1.8V, VFLASH bypass
    //aon1_ctrl_reg->aon1_reg0  = 0xe880c853
    //aon1_ctrl_reg->aon1_reg2  = 0xc5367a00
    //aon1_ctrl_reg->aon1_reg3  = 0x8332
    *(uint32_t*)0x40100160 = 0x4A3200C8;//0x4A2C00C8;  //aon2_ctrl_reg.rf_ctrl0
    *(uint32_t*)0x40102000 = 0xe880c853;  //aon1_ctrl_reg.aon1_reg0,
    *(uint32_t*)0x40102008 = 0xc5367a00;  //aon1_ctrl_reg.aon1_reg2, 
    *(uint32_t*)0x4010200c = 0x8332;      //aon1_ctrl_reg.aon1_reg3, 
#endif
