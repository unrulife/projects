...
static void setup_adv(void)
{
    gap_set_ext_adv_para(0,
                            ...
                            PRIMARY_ADV_ALL_CHANNELS,//PRIMARY_ADV_ALL_CHANNELS, //PRIMARY_ADV_CH_37,  // Primary_Advertising_Channel_Map
                            BD_ADDR_TYPE_LE_RANDOM,    // Own_Address_Type
                            BD_ADDR_TYPE_LE_PUBLIC,    // Peer_Address_Type (ignore)
                            NULL,                      // Peer_Address      (ignore)
                            ADV_FILTER_ALLOW_ALL,      // Advertising_Filter_Policy
                            20,                      // Advertising_Tx_Power
...
{
    static const bd_addr_t rand_addr = { 0xD9, 0x34, 0x35, 0x36, 0x37, 0x96 };
