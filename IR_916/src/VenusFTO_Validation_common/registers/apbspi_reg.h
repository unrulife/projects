...
//                                                                             
// ----------------------------------------------------------------------------
#ifndef APBSPI_REG__H
#define APBSPI_REG__H
...
typedef struct
{
volatile APBSPI_REG_IdRev                                            IdRev                         ; //0x0
volatile uint32_t                                                    null_reg0                     ; //0x4
volatile uint32_t                                                    null_reg1                     ; //0x8
volatile uint32_t                                                    null_reg2                     ; //0xC
volatile APBSPI_REG_TransFmt                                         TransFmt                      ; //0x10
volatile APBSPI_REG_DirectIO                                         DirectIO                      ; //0x14
volatile uint32_t                                                    null_reg3                     ; //0x18
volatile uint32_t                                                    null_reg4                     ; //0x1C
volatile APBSPI_REG_TransCtrl                                        TransCtrl                     ; //0x20
volatile APBSPI_REG_Cmd                                              Cmd                           ; //0x24
volatile APBSPI_REG_Addr                                             Addr                          ; //0x28
volatile APBSPI_REG_Data                                             Data                          ; //0x2C
volatile APBSPI_REG_Ctrl                                             Ctrl                          ; //0x30
volatile APBSPI_REG_Status                                           Status                        ; //0x34
volatile APBSPI_REG_IntrEn                                           IntrEn                        ; //0x38
volatile APBSPI_REG_IntrSt                                           IntrSt                        ; //0x3C
volatile APBSPI_REG_Timing                                           Timing                        ; //0x40
volatile uint32_t                                                    null_reg5                     ; //0x44
volatile uint32_t                                                    null_reg6                     ; //0x48
volatile uint32_t                                                    null_reg7                     ; //0x4C
volatile APBSPI_REG_MemCtrl                                          MemCtrl                       ; //0x50
volatile uint32_t                                                    null_reg8                     ; //0x54
volatile uint32_t                                                    null_reg9                     ; //0x58
volatile uint32_t                                                    null_reg10                    ; //0x5C
volatile APBSPI_REG_SlvSt                                            SlvSt                         ; //0x60
volatile APBSPI_REG_SlvDataCnt                                       SlvDataCnt                    ; //0x64
...
volatile APBSPI_REG_Config                                           Config                        ; //0x7C
}APBSPI_REG_H;
